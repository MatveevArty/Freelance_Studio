...
export class Dashboard {
    ...
    loadOrdersInfo(orders) {
        ...
        // Присваиваем количество заказов в соответствии со статусом заказа
        ...
        document.getElementById('in-progress-orders').innerText = orders.filter(order =>
            [config.orderStatuses.new, config.orderStatuses.confirmed].includes(order.status)).length;
    ...
    loadCalendarInfo(orders) {
        ...
        (new FullCalendar.Calendar(document.getElementById('calendar'), {
            ...
            firstDay: 1, // Установка первого столбца дней ПН, а не ВС по дефолту: https://fullcalendar.io/docs/v3/firstDay
            locale: 'ru',
